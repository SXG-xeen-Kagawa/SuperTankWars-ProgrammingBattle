...
「かんたんAI作成」で行動を選んだあと、AIスクリプトには追加のパラメータが設定されます。  
...
- **Goal Timeout Sec（目標再抽選までの時間）**：短いほど目標をコロコロ変え、長いほど1つの目標に向かい続けます。
- **Move Power（基本となる移動の強さ）**：大きいほど移動が力強くなります。
...
- **Dont Fire Near Edge（外周付近では射撃しない）**：反動で落下しやすい戦車はONにすると安定することがあります。
